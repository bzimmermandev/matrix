...
Which I refer to a matrix's *"cell"*, I am referring to the concept of the container that holds each element. Inherent in each cell are its coordinates in the matrix, and the element that it holds. It is not an actual class, or anything that you should have to worry about.
